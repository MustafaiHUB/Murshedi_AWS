...
function RecordIcon({ toggleRecording }) {
  // translate-y-[-60%] => with not message
  return (
    <button
      data-testid='speech-button'
      aria-label='Start voice mode'
      className='absolute top-1/2 translate-y-[-30%] right-2 flex h-9 items-center justify-center rounded-full bg-black text-white hover:opacity-70 dark:bg-white dark:text-black w-9 transition-all duration-300'
